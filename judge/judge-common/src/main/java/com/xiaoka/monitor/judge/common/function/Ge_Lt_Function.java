...
public class Ge_Lt_Function extends RuleExpressionFunction {

    private Ge_Lt_Function() {
    }

    private static class CondBetweenFunctionInner {
        public static final Ge_Lt_Function instance = new Ge_Lt_Function();
    }

    public static final Ge_Lt_Function getInstance() {
