...
public class Gt_Le_Function extends RuleExpressionFunction {

    private Gt_Le_Function() {
    }

    private static class CondBetweenFunctionInner {
        public static final Gt_Le_Function instance = new Gt_Le_Function();
    }

    public static final Gt_Le_Function getInstance() {
